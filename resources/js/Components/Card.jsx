...
const Card = ({size='big'}) => {
  ...
  return (
    ...
    <div className="absolute bottom-0 left-0 right-0 py-4 px-3 rounded-b-xl bg-gradient-to-t from-black via-black to-transparent hover:py-6 transition-all duration-300 flex justify-between">
      <div id="">
        <div className=" font-extrabold text-white flex flex-col text-left">
      <h3 className="font-bold text-2xl py-1 text-white border-b-2 mb-1">Gamers Connect</h3>
          <p className="text-md text-white/50">At</p>
          <span className=" capitalize text-lg text-red">DDN</span>
     
        </div>
        {/* <h3 className="font-bold text-xl py-1 text-white border-b-2 border-dashed">Gamers Connect</h3>
